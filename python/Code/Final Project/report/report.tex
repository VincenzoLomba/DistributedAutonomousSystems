...
\end{equation*}
with $Q_i \in \mathbb{R}^{d \times d}$ a symmetric \textbf{positive definite} matrix, and $b_i \in \mathbb{R}^d$ a vector. These properties ensure that each $\ell_i(z)$ has a \textbf{unique minimizer} and is differentiable, with gradient:
\begin{equation*}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=1\textwidth]{figs/cons_sim1_zoom.png}
    \caption{ Estimates Evolution over Iterations Zoomed View (sim 1)}
\end{figure}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=1\textwidth]{figs/cons_targ0_sim3_zoom.png}
    \caption{Position Estimate of Target 0 over Iterations Zoomed View (sim 3)}
\end{figure}
\begin{figure}[H] 
    \centering
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=1\textwidth]{figs/cons_targ1_sim3_zoom.png}
    \caption{Position Estimate of Target 1 over Iterations Zoomed View (sim 3)}
\end{figure}
\begin{figure}[H] 
    \centering
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=1\textwidth]{figs/cons_targ2_sim3_zoom.png}
    \caption{Position Estimate of Target 2 over Iterations Zoomed View (sim 3)}
\end{figure}
\begin{figure}[H] 
    \centering
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.6\textwidth]{figs/G_sim3.png}
    \caption{Communication Graph (sim 3)}
\end{figure}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.6\textwidth]{figs/G_sim4.png}
    \caption{Communication Graph (sim 4)}
\end{figure}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=1\textwidth]{figs/G_sim5.png}
    \caption{Communication Graph (sim 5)}
\end{figure}
%%%%%%%%%% Chapter 2 %%%%%%%%%%
...
\begin{itemize}
    ...
    \item \textbf{Key Features:}
    \begin{itemize}
    \item Contains \texttt{AgentData} and \texttt{aggregativeSetup} classes for system configuration
...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
\textbf{Rviz2 Visualizer (\texttt{the\_rviz2visualizer.py})}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{figs/sigma1_sim1_t2.1_zoom.png}
    \caption{Barycenter Estimate Component 1 Zoomed View (sim 1)}
\end{figure}
\begin{figure}[H] 
    \centering
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{figs/sigma2_sim1_t2.1_zoom.png}
    \caption{Barycenter Estimate Component 2 Zoomed View (sim 1)}
\end{figure}
\begin{figure}[H] 
    \centering
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{figs/sigma1_sim2_t2.1_zoom.png}
    \caption{Barycenter Estimate Component 1 Zoomed View (sim 2)}
\end{figure}
\begin{figure}[H] 
    \centering
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.8\textwidth]{figs/sigma2_sim2_t2.1_zoom.png}
    \caption{Barycenter Estimate Component 2 Zoomed View (sim 2)}
\end{figure}
\begin{figure}[H] 
    \centering
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=1\textwidth]{figs/mainplots_sim1_t2.2.png}
    \caption{Total Cost, Gradient Norm, Sigma Estimation Error over Iterations (sim 1 ROS2)}
\end{figure}
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.6\textwidth]{figs/rv_sim1.png}
    \caption{Rviz2 Visualization (sim 1)}
\end{figure}
\subsubsection{Simulation 2}
Note that the plots below are identical to those from Simulation 2 in Task 2.1, except for the sigma estimation error, which differs due to numerical issues in ROS2.
\begin{figure}[H] 
    \centering
    \includegraphics[width=1\textwidth]{figs/mainplots_sim2_t2.2.png}
    \caption{Total Cost, Gradient Norm, Sigma Estimation Error over Iterations (sim 2 ROS2)}
\end{figure}
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.6\textwidth]{figs/rv_sim2.png}
    \caption{Rviz2 Visualization (sim 2)}
\end{figure}
