...
This folder contains all the code related to Task 2.1 of the DAS Final Project. It implements a multi-robot (AKA multi-agent) aggregative optimization algorithm with visualization and animation capabilities.<br>
